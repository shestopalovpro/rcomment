...
/**
 * Add voting UI next to reply link
 */
function cr_add_voting_ui($reply_link, $args, $comment)
{
    ...
    $voting_html = '
    <div class="cr-voting-wrapper" data-comment-id="' . esc_attr($comment_id) . '">
    ...
    // Place voting buttons before the reply link
    return $voting_html . $reply_link;
}
add_filter('comment_reply_link', 'cr_add_voting_ui', 10, 3);
